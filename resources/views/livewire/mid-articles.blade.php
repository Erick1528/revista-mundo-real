<div class="max-w-[1200px] mx-auto mt-16 pt-0 pb-12 px-4">
    ...
    <div class=" flex flex-col sm:grid sm:grid-cols-3 gap-8">
        ...
        <a href="#" class=" group cursor-pointer">
            ...
            <div class=" space-y-2">
                <p class=" text-xs font-semibold uppercase font-montserrat text-gray-light tracking-wider">
                    Cultura Viva
                </p>

                <h2
                    class=" text-xl font-serif text-primary text-balance group-hover:text-dark-sage transition-all duration-200">
