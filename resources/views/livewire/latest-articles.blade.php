<div class="max-w-[1200px] mx-auto mb-16 pt-0 px-4">
    ...
    <div class=" flex flex-col sm:grid sm:grid-cols-2 sm:grid-rows-2 gap-x-8 gap-y-12">
        ...
        <div class=" group cursor-pointer h-fit">
            ...
            <div class=" space-y-2">
                <p class="text-xs font-semibold uppercase font-montserrat text-gray-light tracking-wider">Eventos
                    Sociales</p>
        ...
        <div class=" group cursor-pointer h-fit">
            ...
            <div class=" space-y-2">
                ...
                <h3 class=" text-xl sm:text-2xl font-serif text-primary group-hover:text-dark-sage transition-all duration-200">San
                    Francisco: La Ciudad de las Mil Colinas y Culturas</h3>
        ...
        <div class=" group cursor-pointer h-fit">
            ...
            <div class=" space-y-2">
                <p class="text-xs font-semibold uppercase font-montserrat text-gray-light tracking-wider">Salud y
                    Bienestar</p>
        ...
        <div class=" group cursor-pointer h-fit">
            ...
            <div class=" space-y-2">
                <p class="text-xs font-semibold uppercase font-montserrat text-gray-light tracking-wider">Cultura Viva
                </p>
