            ...
            @if($deleteModalBlockedByUse)
                <div class="text-center mb-4 sm:mb-6">
                    ...
                    <p class="text-xs sm:text-sm font-opensans text-gray-light leading-relaxed mb-3">
                        El anuncio <strong class="font-semibold text-primary">{{ $selectedAdName }}</strong> está en uso en uno o más artículos. Quita el anuncio del contenido de esos artículos si quieres moverlo a la papelera.
                    </p>
                </div>
