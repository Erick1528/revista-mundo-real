<div class="px-4 sm:px-10 lg:px-[120px] py-12 max-w-[1200px] mx-auto w-full">
    ...
    <p class="text-sm text-gray-light font-opensans mb-8">
        Temas sugeridos eliminados. Puedes restaurarlos para que vuelvan al listado o eliminarlos permanentemente.
    </p>
    ...
    <div class="space-y-3 sm:space-y-4">
            ...
            <div class="border border-gray-lighter p-4 sm:p-6 hover:bg-sage/30 transition-all duration-200">
                <div class="flex flex-col gap-3 sm:flex-row sm:flex-wrap sm:items-start sm:justify-between">
                    <div class="min-w-0 flex-1">
                        ...
                        @endif
                        <p class="font-opensans text-xs sm:text-sm text-gray-light mt-1">
                            Eliminado {{ $topic->deleted_at->locale('es')->diffForHumans() }}
                            @if ($topic->creator)
                    ...
                    <div class="flex flex-wrap gap-2 items-center shrink-0">
                        <button type="button" wire:click="restoreTopic({{ $topic->id }})"
                        ...
                        <button type="button" wire:click="openForceDeleteModal({{ $topic->id }})"
        ...
        @empty
            <div class="border border-gray-lighter p-6 sm:p-8 text-center">
                ...
                <p class="text-gray-light font-opensans">No hay temas sugeridos eliminados</p>
                <a href="{{ route('suggested-topics.index') }}"
                    class="inline-block mt-4 text-dark-sage hover:text-primary font-opensans text-sm">
                    Volver a Temas sugeridos
                </a>
            </div>
        @endforelse
    </div>
    ...
    {{-- Modal de eliminación permanente (irreversible) --}}
        ...
        <div class="bg-white shadow-xl max-w-md w-full p-4 sm:p-8 mx-4 border border-gray-lighter" @click.stop>
            <div class="text-center mb-4 sm:mb-6">
                ...
                <p class="text-xs sm:text-sm font-opensans text-gray-light leading-relaxed mb-3">
                    El tema <strong class="font-semibold text-primary">{{ $selectedTopicTitle }}</strong> se borrará para siempre. Esta acción <strong class="font-semibold text-red-500">no se puede deshacer</strong> y es irreversible.
                </p>
                <p class="text-xs sm:text-sm font-opensans text-gray-light leading-relaxed">
                    ¿Estás seguro de que deseas eliminarlo definitivamente?
                </p>
            </div>
