    ...
    <form wire:submit.prevent="createUser" class="space-y-4">
        <div class="border border-gray-lighter">
            <div class="px-4 sm:px-6 py-3 sm:py-4 border-b border-gray-lighter">
                <h3 class="font-montserrat font-medium text-primary text-sm sm:text-base">Datos del nuevo usuario</h3>
            </div>
            <div class="px-4 sm:px-6 py-4 sm:py-6 space-y-4 sm:space-y-6">
                <div class="space-y-2">
                    <label for="name" class="block text-sm font-montserrat font-medium text-primary">Nombre</label>
                ...
                <div class="space-y-2">
                    <label for="email" class="block text-sm font-montserrat font-medium text-primary">Correo electrónico</label>
                    <input type="email" id="email" placeholder="correo@ejemplo.com" wire:model="email"
                        class="w-full px-4 py-3 border @error('email') border-red-500 @else border-gray-300 @enderror bg-gray-50 focus:outline-none focus:border-dark-sage focus:shadow-[0_0_0_2px_rgba(183,182,153,0.5)] font-opensans text-sm">
                    @error('email')
                        <p class="text-red-500 text-xs font-opensans">{{ $message }}</p>
                    @enderror
                </div>
                <div class="space-y-2">
                    <p class="text-xs text-gray-500 font-opensans">Se generará una contraseña temporal y se enviará al correo del usuario para que pueda iniciar sesión y cambiarla desde su perfil.</p>
                </div>
                <div class="space-y-2">
                    <label for="rol" class="block text-sm font-montserrat font-medium text-primary">Rol</label>
